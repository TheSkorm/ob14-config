...
#define PID_MAX BANG_MAX // limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
  ...
  // Ultimaker
    #define  DEFAULT_Kp 44.58
    #define  DEFAULT_Ki 5.50
    #define  DEFAULT_Kd 90.39
...
#define Z_PROBE_REPEATABILITY_TEST  // If not commented out, Z-Probe Repeatability test will be included if Auto Bed Leveling is Enabled.
  ...
  #define Y_PROBE_OFFSET_FROM_EXTRUDER 22    // Probe on: -front +behind
  #define Z_PROBE_OFFSET_FROM_EXTRUDER -0.2  // -below (always!) //10.93
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,1600,88}  // default steps per unit for Ultimaker
...
#define ABS_PREHEAT_HPB_TEMP 130
